...
public class ServiceAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.community_service_item,
					null);

			holder = new CommunityViewHolder();
			holder.name = (TextView) convertView
					.findViewById(R.id.community_service_name);
			holder.availableText = (TextView) convertView
					.findViewById(R.id.community_service_available_text);
			holder.image = (ImageView) convertView
					.findViewById(R.id.community_service_image);
